    ...
    <div className="max-w-md mx-auto px-4 pt-4 pb-24">
      ...
      <div className="mt-8">
        <div className="relative mb-3">
          ...
          <span
            className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-bg-primary text-rose section-label px-2"
            style={{ textShadow: '0 0 8px var(--color-rose-glow)' }}
          >
            Danger Zone
          </span>
        </div>
